...
export default function Testimonial(props) {
  ...
  return (
    <div>
      <ScreenHeading
        title={"Temoignages"}
        subHeading={"Ce que mon client dit de moi"}
      />
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      J'ai engagé Rodrigue et quand il a livré, honnêtement,
                      j'ai est tombé amoureux du projet. C'est un gars très
                      honnête et il livre à temps.
